...
export default function Cheatsheet() {
  ...
  // Safe in-view for the CTA section (fallback if observer callback is lost
  // after an instant navigation — content must never stay invisible).
  const cta = useSafeInView<HTMLElement>({ once: true, margin: '-10% 0px' });
    ...
    <div>
      ...
      <div className="mx-auto max-w-7xl space-y-14 px-6 py-14 lg:px-8">
        ...
        <motion.section
          ...
          animate={cta.shown ? { opacity: 1, y: 0 } : undefined}
