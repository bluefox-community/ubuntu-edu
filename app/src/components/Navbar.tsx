...
export default function Navbar() {
  ...
  // Publish the navbar's effective height as a CSS variable so sticky sub-bars
  // (lesson TopBar, Practice FilterBar, Cheatsheet QuickNav) slide up to top:0
  // when the navbar hides — otherwise a 64px hole shows content scrolling by.
  useEffect(() => {
  ...
  useEffect(() => {
    setOpen(false);
    setHidden(false); // always show the navbar after a route change
  }, [location.pathname]);
